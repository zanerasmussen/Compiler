...
class NotEVisitor(ASTVisitor):
    ...
    def post_visit_ExpressionNot(self, node: ASTExpressionNot):
        ...
        self.add_line_asm(node, " ", "ADI", "R7,", "#48") #fix this value
        self.add_line_asm(node, " ", "BRZ", "R10,", "$NEGATEZERO")
        self.add_line_asm(node, " ", "BLT", "R10,", "$NEGATEONE")
        self.add_line_asm(node, " ", "BGT", "R10,", "$NEGATEONE")
